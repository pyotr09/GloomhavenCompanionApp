...
function App(props) {
                ...
                <Box sx={{mt: 8}}>
                    <Button 
                        style={getElementButtonStyle(fire, "#d81b60")}
                            ...
                            color={"fire"}
                        onClick={() => {if (fire === 0) setFire(2); else setFire(0);}}
                    ...
                    <Button style={getElementButtonStyle(ice, "#4fc3f7")}
                            ...
                            color={"ice"}
                            onClick={() => {if (ice === 0) setIce(2); else setIce(0);}}
                    ...
                    <Button style={getElementButtonStyle(earth, "#43a047")}
                            ...
                            color={"earth"}
                            onClick={() => {if (earth === 0) setEarth(2); else setEarth(0);}}
                    ...
                    <Button style={getElementButtonStyle(air, "#757575")}
                            ...
                            color={"air"}
                            onClick={() => {if (air === 0) setAir(2); else setAir(0);}}
                    ...
                    <Button style={getElementButtonStyle(light, "#fdd835")}
                            ...
                            color={"light"}
                            onClick={() => {if (light === 0) setLight(2); else setLight(0);}}
                    ...
                    <Button style={getElementButtonStyle(dark, "#212121")}
                            ...
                            color={"dark"}
                            onClick={() => {if (dark === 0) setDark(2); else setDark(0);}}
                            onDoubleClick={() => setDark(1)}
                    >
                        DARK
                    </Button>
                    <PageLayout isScenarioLoaded={isScenarioLoaded} scenario={scenario} setScenario={setScenario} reduceElements={reduceElements}/>
                </Box>
            </Container>
            </ThemeProvider>
        </div>
    ...
    function getElementButtonStyle(el, color) {
        ...
        if (el === 1) {
            return {background: `linear-gradient(to bottom, Transparent 0%,Transparent 50%,${color} 50%,${color} 100%)`
            };
        }
        if (el === 2) {
            return {};
